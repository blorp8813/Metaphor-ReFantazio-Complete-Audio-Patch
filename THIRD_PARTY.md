...
| Ultimate ASI Loader | Loads `MetaphorCompleteAudioPatch.asi` through packaged `winmm.dll` | `third_party/Ultimate-ASI-Loader/` | MIT; `third_party/Ultimate-ASI-Loader/LICENSE.txt` |
